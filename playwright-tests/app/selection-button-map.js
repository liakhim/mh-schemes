...
export const SELECTION_BUTTON_MAP = [
    ...
    // --- 6. Датчики и защита ---
    {
        section: '6. Датчики и защита от протечки — Датчики температуры (общая карточка)',
        local: [
    ...
    {
        section: '6. Датчики и защита от протечки — Контроль протечки воды',
    ...
    {
        section: '6. Датчики и защита от протечки — Запорный клапан',
    ...
    {
        section: '6. Датчики и защита от протечки — Датчик давления',
