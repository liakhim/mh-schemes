...
const nodes = {
    ...
    relayLimit: { x: 728, y: 506, lines: ['Конфликт: 3 / 1', 'выберите одно'], kind: 'limit error', info: 'На эскизе к встроенному RELAY одновременно подведены насос, простой котёл и сервопривод. GO+ допускает только одно такое устройство; остальные следует перенести на RL6W или выбрать старший контроллер.' },
    pump: { x: 820, y: 370, lines: ['Насос'], kind: 'device', info: 'Насос котлового или отопительного контура.' },
    dumbBoiler: { x: 910, y: 460, lines: ['Простой', 'котёл'], kind: 'device', info: 'Котёл с релейным управлением.' },
